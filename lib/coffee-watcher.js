(function() {
  ...
  program.version('1.4.3').usage(usage).option('-d, --directory', 'Specify which directory to scan. [Default: .]').option('-p, --prefix [type]', 'Which prefix should the compiled files have? Default is script.coffee will be compiled to .coffee.style.js.').parse(process.argv);
